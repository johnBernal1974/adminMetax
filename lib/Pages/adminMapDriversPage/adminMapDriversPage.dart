...
class _AdminDriversMapPageState extends State<AdminDriversMapPage> {
  ...
  final Map<String, _DriverAvailable> _quietDrivers = {};
  final Map<String, _DriverAvailable> _inactiveDrivers = {};
  ...
  //** nuevo para ver activos reales//**************

  String _estadoActividad(Map<String, dynamic> data) {
    try {
      final now = DateTime.now();

      final pos = data['position'];
      if (pos == null) return "inactivo";

      final updatedAt = pos['updatedAt']?.toDate();
      if (updatedAt == null) return "inactivo";
